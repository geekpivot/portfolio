...
<html lang="en" >
  <head>
    ...
    <title>James Coonce | Web Developer</title>
    <!--favicon-->
    ...
    <div class="wrapper">
      ...
      <header class="main-header" id="home">
        <div class="content-table header-content-fixed ">
          ...
          <div class="v-content">
            <div class="container">
              <h1 class="text-uppercase color-dark name">I'm James Coonce</h1>
              <h4  class="text-uppercase color-dark font-alt job">A <span id="typed" class="typed"></span></h4>
            </div>
          </div>
        </div>
            ...
            <div class="container">
              <div class="row">
                ...
                <div class="col-md-3">
                  <ul class="breadcrumb main-nav no-space">
                    <li>
                      <a href="https://www.facebook.com/james.coonce1" ><i class="fa fa-facebook"></i></a>
                    </li>
                    <li>
                      <a href="https://plus.google.com/+JamesCoonceprogrammer/about"  ><i class="fa fa-google"></i></a>
                    </li>
                    <li>
                      <a href="https://twitter.com/jamescoonce"  ><i class="fa fa-twitter"></i></a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="https://github.com/geekpivot" ><i class="fa fa-github"></i></a>
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <section id="about" class="block-section">
          ...
          <div class="my-pict" >
            <div class="overfly">
              <div class="text-botttom">
                <h2 class="text-uppercase color-dark text-bold">James Coonce</h2>
                <h5 class="text-uppercase color-dark font-alt ">Code Hard, Play Hard</h5>
              </div>
            </div>
          </div>
          <div class="my-desc">
            <div class="bg-secondary clearfix">
              <div class="inner-text">
                <h3 class=" color-dark no-margin-top">Bienvenido!</h3>
                <p>I primarily build my projects in Laravel but I have interest in Ruby on Rails and have built a few demos that are displayed on my <a href="http://github.com/neozelkova">Github</a>. I'm the founder of GeekPivot LLC and I have a passion for learning languages. I'm currently working on a language learning platform. If you are interested in the project and would like to get involved, please <a href="#contact">contact me</a>.</p>
                <p class="no-margin">In 2010 I first started learning how to program on my free time. I start off designing small games and apps for Android and began to focus on software development in college. Even though my main focus for personal projects are based in PHP, I have worked with teams in the industry where I've had to extensively use my skills with Java web and mobile development.</p>
              </div>
            </div>
            <div class="bg-dark clearfix">
              <div class="inner-text">
                <p class="no-margin color-light ">
                  <strong class="fix-width-100"><i class="fa fa-calendar margin-right-5"></i> Birthdate</strong> : 10/22/1992<br/>
                  <strong class="fix-width-100"><i class="fa fa-skype margin-right-5"></i> Skype</strong> : Neozelkova22<br/>
                  <strong class="fix-width-100"><i class="fa fa-phone margin-right-5"></i> Phone</strong> :813-384-8583 <br/>
                  <strong class="fix-width-100"><i class="fa fa-envelope margin-right-5"></i> Email</strong> : coonce.james@gmail.com<br/>
                  <strong class="fix-width-100"><i class="fa fa-globe margin-right-5"></i> Website</strong> : www.jamescoonce.me<br/>
        ...
        <div class="container">
          <ul class="services list-unstyled clearfix">
            ...
            <li class="col-sm-4 no-padding">
              <div class="box">
                <div class="ic"><i class="fa fa-mobile"></i></div>
                <h5 class="text-uppercase color-dark">Mobile Developer</h5>
              </div>
            </li>
            <li class="col-sm-4 no-padding">
              <div class="box ">
      ...
      <section id="resume" class="block-section">
            ...
            <ul class="list-unstyled  clearfix">
              ...
              <li>
                ...
                <div class="desc">
                  ...
                  <p class="font-alt color-dark">Concept Software and Services</p>
                  <p>Full stack devlopement that consisted of consulting with clients about the needs of their projects and developing the infrastuctured needed to execute the project.</p>
                  <p class="font-alt color-dark"> 2014-2015</p>
                </div>
              </li>
          ...
          <div class="list-education">
            <ul class="list-unstyled  clearfix">
              <li>
                ...
                <div class="number font-alt">01</div>
                <div class="desc">
                  <h5 class="text-uppercase color-dark text-bold">Florida Institute of Technology</h5>
        ...
        <div class="container-medium">
          ...
          <div class="title-border">
            <h5 class="text-uppercase color-dark no-margin text-bold ">CORE SKILLS</h5>
          </div>  
          ...
          <div class="row">
            <div class="col-sm-6">
              <ul class="list-unstyled list-progress">
                <li>
                  <div class="text-uppercase color-dark title "><span>HTML &amp; CSS</span>  <small>90%</small></div>
                  <div class="progress-line">
                    <div class="line" data-holdwidth="90%"></div>
                  </div>
                </li>
                <li>
                  <div class="text-uppercase color-dark title">PHP   <small>80%</small></div>
                  <div class="progress-line">
                    <div class="line" data-holdwidth="80%"></div>
                  </div>
                </li>
                <li>
                  <div class="text-uppercase color-dark title">Java   <small>70%</small></div>
                  <div class="progress-line">
            ...
            <div class="col-sm-6">
              <ul class="list-unstyled list-progress">
                <li>
                  <div class="text-uppercase color-dark title">JavaScript <small>70%</small></div>
                  <div class="progress-line">
                    <div class="line" data-holdwidth="70%" ></div>
                  </div>
                </li>
                ...
                <li>
                  <div class="text-uppercase color-dark title">WordPress  <small>80%</small></div>
                  <div class="progress-line">
                    <div class="line" data-holdwidth="80%" ></div>
                  </div>
                </li>
        ...
        <div class="parallax-bg bg1" >
          <div class="container">
            <div class="padding30 text-center">
              <a href="http://github.com/neozelkova" class="btn btn-flat-line btn-default light-font "><i class="fa fa-github"></i>  Github</a>
              <span class="space-inline-15 hidden-xs"></span>
              <a href="#" class="btn btn-flat-line btn-default light-font"><i class="fa fa-pencil"></i> Blog</a>
            </div>
          </div>
        ...
        <div class="contact-area">
              ...
              <div id="myTabContent" class="tab-content flat-tab-content">
                ...
                <div class="tab-pane fade" id="tab1">
                  <form method="post">
                    ...
                    <div class="form-group">
                      <label>Attach Your Document <span class="display-block color-dark">(only .pdf  allowed , max size 20MB)</span></label>
          ...
          <div class="hidden map-contact-body">
            <div class="map-content">
              <h4 class="color-dark no-margin-top font-alt">My Location</h4>
              <p><i class="fa fa-map-marker"></i> <strong>Address:</strong> 1034 Wood Creek Trail, Roswell GA</p>
              <p><i class="fa fa-mobile"></i> <strong>Phone:</strong> 813-300-5153 </p>
              <p><i class="fa fa-envelope"></i> <strong>Email:</strong> coonce.james@gmail.comm</p>
            </div>
          </div>
          <!--END MAP-->
        </div>
